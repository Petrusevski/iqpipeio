...
const CONNECTORS = [
  { name: "n8n",          category: "Automation",  status: "stable",      desc: "Sync workflows, execution events, error logs",         icon: "⚡" },
  { name: "Make.com",     category: "Automation",  status: "stable",      desc: "Scenario metadata, module health, run history",       icon: "🔧" },
  { name: "HubSpot",      category: "CRM",         status: "stable",      desc: "Contacts, deals, pipeline stages, activity feed",     icon: "🟠" },
  { name: "Salesforce",   category: "CRM",         status: "stable",      desc: "Leads, opportunities, accounts, field mappings",      icon: "☁️"  },
  { name: "Pipedrive",    category: "CRM",         status: "stable",      desc: "Deals, persons, organizations, activities",           icon: "🟢" },
  { name: "Apollo.io",    category: "Outreach",    status: "stable",      desc: "Sequences, contacts, email events, reply detection",  icon: "🚀" },
  { name: "Instantly",    category: "Outreach",    status: "stable",      desc: "Campaign sends, opens, replies, bounce tracking",     icon: "⚡" },
  { name: "Lemlist",      category: "Outreach",    status: "stable",      desc: "Sequence steps, email events, LinkedIn actions",      icon: "📧" },
  { name: "HeyReach",     category: "LinkedIn",    status: "stable",      desc: "Connection requests, messages, accept events",        icon: "💼" },
  { name: "Expandi",      category: "LinkedIn",    status: "stable",      desc: "Campaign events, profile visits, connection accepts", icon: "🔗" },
  { name: "Clay",         category: "Enrichment",  status: "stable",      desc: "Enrichment runs, field updates, table webhooks",      icon: "🧱" },
  { name: "Clearbit",     category: "Enrichment",  status: "stable",      desc: "Person + company enrichment, reveal events",         icon: "🔍" },
  { name: "Stripe",       category: "Billing",     status: "stable",      desc: "Payment events, subscriptions, churn signals",       icon: "💳" },
  { name: "Chargebee",    category: "Billing",     status: "stable",      desc: "Subscription lifecycle, MRR events, trials",         icon: "💰" },
  { name: "Aircall",      category: "Phone",       status: "stable",      desc: "Call logs, duration, outcomes, recordings meta",     icon: "📞" },
  { name: "Twilio",       category: "SMS",         status: "stable",      desc: "SMS send/receive, delivery status, opt-outs",        icon: "📱" },
  { name: "Slack",        category: "Comms",       status: "beta",        desc: "Channel messages, reaction events, user activity",   icon: "💬" },
  { name: "GitHub",       category: "Dev",         status: "beta",        desc: "PR events, commits, issue activity, CI signals",     icon: "🐙" },
  { name: "Attio",        category: "CRM",         status: "coming_soon", desc: "Records, notes, tasks, workspace activity",          icon: "🟣" },
  { name: "Intercom",     category: "Support",     status: "coming_soon", desc: "Conversations, user events, product signals",        icon: "💡" },
];
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          >
            ...
            <a href="#connectors" className="inline-flex items-center gap-2 rounded-lg border border-slate-600 hover:border-slate-400 bg-slate-800/60 hover:bg-slate-800 px-5 py-2.5 text-sm font-medium text-slate-300 transition-colors">
              ...
              {CONNECTORS.filter(c => c.status === "stable").length} Connectors
            </a>
          </motion.div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 flex gap-10 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-20">
          ...
          <section id="quickstart" ref={sectionRef("quickstart")}>
            ...
            <p className="text-slate-400 leading-relaxed mb-8">
              Three paths depending on your client. All require a{" "}
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
                  <span className="text-base">🤖</span> Option A — Claude Desktop
                </h3>
              ...
              <div>
                <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
                  <Package className="w-4 h-4 text-indigo-400" /> Option B — Node.js SDK
                </h3>
              ...
              <div>
                <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
                  <Terminal className="w-4 h-4 text-indigo-400" /> Option C — Interactive CLI
                </h3>
                <p className="text-xs text-slate-500 mb-3">Scaffolds config, prompts for API key, and verifies the connection.</p>
